          ...
          <div>
            ...
            <div className="h-20 flex items-center px-6 border-b border-slate-200/30 dark:border-slate-700/50">
              <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-blue-500 to-blue-700 flex items-center justify-center shadow-lg shadow-blue-500/30">
                <span className="material-symbols-rounded text-white text-xl">local_shipping</span>
              </div>
              <span className="ml-3 font-bold text-lg tracking-wide text-slate-800 dark:text-white">Kargo Sistemi</span>
            </div>
            ...
            <nav className="flex flex-col gap-2 p-4 mt-2">
              {adminMenuItems.map((item) => (
                ...
                >
                  ...
                  <span className={`material-symbols-rounded text-xl ${!isActive(item.path) && 'group-hover:text-primary transition-colors'}`}>
                    {item.icon}
                  </span>
          ...
          <div className="p-4 border-t border-slate-200/30 dark:border-slate-700/50 relative">
            ...
            >
              ...
              <div className="flex flex-col flex-1">
                <span className="text-sm font-semibold text-slate-800 dark:text-white">{user.fullName}</span>
          ...
          <header className="h-16 flex-shrink-0 rounded-2xl glass flex items-center justify-between px-6 shadow-lg">
            <div className="flex items-center text-slate-500 dark:text-slate-400 text-sm">
              ...
              <span className="text-slate-800 dark:text-slate-200 font-medium">
                {adminMenuItems.find(item => isActive(item.path))?.text || 'Dashboard'}
              </span>
            </div>
